...
namespace Mindbox.Data.Linq.Entity.ModelConfiguration.Configuration
{
	...
	public abstract class LengthColumnConfiguration : PrimitiveColumnConfiguration
	{
		...
		/// <returns>The same <see cref="T:Mindbox.Data.Linq.Entity.ModelConfiguration.Configuration.LengthColumnConfiguration" /> instance so that multiple calls can be chained.</returns>
